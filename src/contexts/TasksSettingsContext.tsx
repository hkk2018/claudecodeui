...
const TasksSettingsContext = createContext({
  tasksEnabled: true as boolean,
  setTasksEnabled: (value: any): any => {},
  toggleTasksEnabled: () => {},
  isTaskMasterInstalled: null as any,
  isTaskMasterReady: null as any,
  installationStatus: null as any,
...
export const TasksSettingsProvider = ({ children }: any) => {
