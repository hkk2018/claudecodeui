...
const TaskMasterContext = createContext({
  ...
  projectTaskMaster: null as any,

  // MCP server state
  mcpServerStatus: null as any,
  ...
  // Actions
  refreshProjects: (project?: any): any => {},
  setCurrentProject: (project: any): any => {},
  refreshTasks: (): any => {},
  refreshMCPStatus: (): any => {},
  clearError: () => {}
});
...
export const TaskMasterProvider = ({ children }: any) => {
