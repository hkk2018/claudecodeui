...
export const api = {
  ...
  sessionMessages: (projectName: string, sessionId: string, limit: number | null = null, offset: number = 0) => {
  ...
  overlay: {
    ...
    focusIdeByName: (projectName) =>
      authenticatedFetch('/api/overlay/ide-projects/focus-by-name', {
        method: 'POST',
  ...
  post: (endpoint, body?: any) => authenticatedFetch(`/api${endpoint}`, {
    method: 'POST',
    body: body ? JSON.stringify(body) : undefined,
  }),

  // Update session
  updateSession: (sessionId: string, updates: Record<string, any>) =>
