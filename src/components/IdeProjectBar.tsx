          ...
          {loading.value && projects.value.length === 0 ? (
            ...
            projects.value.map((project) => (
              <button
                ...
                className="px-3 py-1.5 text-sm bg-background hover:bg-primary/10 border border-border hover:border-primary rounded-md transition-colors flex-shrink-0 max-w-[20ch] truncate"
