  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const taskData = formData.useAI
        ? { prompt: formData.prompt, priority: formData.priority, title: '', description: '', dependencies: [] }
        : { title: formData.title, description: formData.description, priority: formData.priority, prompt: '', dependencies: [] };
...
const TemplateSelector = ({ currentProject, onClose, onTemplateApplied }) => {
  ...
  const handleSelectTemplate = (template) => {
    ...
    uniquePlaceholders.forEach((placeholder: any) => {
